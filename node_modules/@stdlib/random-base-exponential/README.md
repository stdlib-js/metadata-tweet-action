...
```bash
npm install @stdlib/random-base-exponential
```
...
[test-image]: https://github.com/stdlib-js/random-base-exponential/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/random-base-exponential/actions/workflows/test.yml
